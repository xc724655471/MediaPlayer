...
bool RTMPReceiver::RTMPReceiverInit(char * url, bool bWriteFile, int streamtype)
{
	...
	//10 minute
	RTMP_SetBufferMS(m_pRtmp, 600 * 1000);
...
bool RTMPReceiver::RTMPReceiverStart()
{
	...
	while (RTMP_ReadPacket(m_pRtmp, &pc))
	{
